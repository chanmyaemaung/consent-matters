...
INSERT INTO "new_Settings" ("acceptBgColor", "acceptLabel", "acceptTextColor", "autoMatchTheme", "bannerEnabled", "bannerText", "bgColor", "countries", "createdAt", "declineLabel", "id", "onboardingDismissed", "position", "shop", "targetingMode", "textColor", "updatedAt") SELECT "acceptBgColor", "acceptLabel", "acceptTextColor", "autoMatchTheme", "bannerEnabled", "bannerText", "bgColor", "countries", "createdAt", "declineLabel", "id", "onboardingDismissed", "position", "shop", "targetingMode", "textColor", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
