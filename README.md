...
<img src="assets/01-hero.png" alt="Consent Matters" width="100%" />
...
![Free forever](https://img.shields.io/badge/price-100%25%20free-00A47C)
![GDPR ready](https://img.shields.io/badge/GDPR-ready-00A47C)
![Speed impact](https://img.shields.io/badge/speed%20impact-zero-00A47C)
...
| | |
| --- | --- |
| ![Block tracking](assets/02-blocking.png) | ![Preferences](assets/03-preferences.png) |
| ![Layouts](assets/04-layouts.png) | ![Withdraw consent](assets/05-withdraw.png) |
| ![Admin home](assets/06-admin-home.png) | ![Targeting](assets/07-admin-targeting.png) |

![Appearance](assets/08-admin-appearance.png)
...
community. If it saves you money and you'd like to support development,
you can send crypto. **Entirely optional.**

> ⚠️ **Send only on the exact network listed. Wrong network = permanent
> loss of funds.**

| Coin | Network | Address |
| ---- | ------- | ------- |
| USDT | TRON (TRC20) **only** | `TVADhGxN3HKUzjLxZBckpWXA8vRkRpHHtD` |
| USDC | BNB Chain (BEP20) **only** | `0x8210A34c02FC96C9E09B4556be949eAaC8615895` |
| BNB  | BNB Chain (BEP20) **only** | `0x8210A34c02FC96C9E09B4556be949eAaC8615895` |
| BTC  | Bitcoin **only** | `bc1qtrzawm62zc77pveg5epupm4up9x5682k3pfkkz` |
